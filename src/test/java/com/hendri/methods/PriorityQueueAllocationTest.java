...
class PriorityQueueAllocationTest
{

	@Test
	void priorityNoInterference(){
		Set<Cell> testData = Set.of(A, B, C);
		Set<RegisteredCell> actual = PriorityQueueAllocation.priorityAllocate(testData, FREQUENCIES);
	...
	@Test
	void priorityPredictiveInterference(){
